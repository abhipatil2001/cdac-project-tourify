...
export default function Profile() {
    ...
    }, [actualToken]); // Dependency array contains only `token`, so the effect runs only on mount and when `token` changes
